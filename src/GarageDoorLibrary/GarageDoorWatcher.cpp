...
void GarageDoorWatcher::UnregisterFromBus()
{
    ...
    {
        PCSTR interfaces[] = { "net.protosystem.GarageDoor" };
    ...
    _In_ const alljoyn_msgarg aboutDataArg)
{
    ...
    if (alljoyn_aboutobjectdescription_hasinterface(objectDescription, "net.protosystem.GarageDoor"))
    {
        AllJoynServiceInfo^ args = ref new AllJoynServiceInfo(
            AllJoynHelpers::MultibyteToPlatformString(name),
            AllJoynHelpers::GetObjectPath(objectDescription, "net.protosystem.GarageDoor"),
            port);
