...
public:
    ...
    // Send a signal to all members of the session to notify them that the value of Location has changed.
    void EmitLocationChanged();

    // Send a signal to all members of the session to notify them that the value of DoorState has changed.
    void EmitDoorStateChanged();
...
private:
    static void CallOpenOrCloseGarageHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallOpenGarageHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallCloseGarageHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
