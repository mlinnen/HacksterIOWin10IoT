...
public ref class GarageDoorDoorState sealed
{
public:
    property byte Value1
    {
        byte get() { return m_value1; }
        void set(byte value) { m_value1 = value; }
    }
...
{
internal:
    static _Check_return_ int32 GetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _Out_ net::protosystem::GarageDoor::GarageDoorDoorState^* value)
    {
        UNREFERENCED_PARAMETER(signature);

        (*value) = ref new net::protosystem::GarageDoor::GarageDoorDoorState();
        ...
        byte value1;
        RETURN_IF_QSTATUS_ERROR(GetAllJoynMessageArg(argument1, "y", &value1));
        (*value)->Value1 = value1;
    ...
    static _Check_return_ int32 SetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _In_ net::protosystem::GarageDoor::GarageDoorDoorState^ value)
    {
        UNREFERENCED_PARAMETER(signature);

        auto argument1 = alljoyn_msgarg_create();
        RETURN_IF_QSTATUS_ERROR(SetAllJoynMessageArg(argument1, "y", value->Value1));
