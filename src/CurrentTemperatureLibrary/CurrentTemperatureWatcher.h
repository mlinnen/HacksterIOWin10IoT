...
ref class CurrentTemperatureWatcher;

public interface class ICurrentTemperatureWatcher
{
    event Windows::Foundation::TypedEventHandler<CurrentTemperatureWatcher^, Windows::Devices::AllJoyn::AllJoynServiceInfo^>^ Added;
    event Windows::Foundation::TypedEventHandler<CurrentTemperatureWatcher^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
};

public ref class CurrentTemperatureWatcher sealed : [Windows::Foundation::Metadata::Default] ICurrentTemperatureWatcher
{
public:
    CurrentTemperatureWatcher(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~CurrentTemperatureWatcher();

    // This event will fire whenever a producer for this service is found.
    virtual event Windows::Foundation::TypedEventHandler<CurrentTemperatureWatcher^, Windows::Devices::AllJoyn::AllJoynServiceInfo^>^ Added;

    // This event will fire whenever the watcher is stopped.
    virtual event Windows::Foundation::TypedEventHandler<CurrentTemperatureWatcher^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
