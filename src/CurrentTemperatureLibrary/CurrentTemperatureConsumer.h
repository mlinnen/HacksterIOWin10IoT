...
public interface class ICurrentTemperatureConsumer
{
    event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Platform::Object^>^ VersionChanged;
    event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Platform::Object^>^ CurrentValueChanged;
};

public ref class CurrentTemperatureConsumer sealed  : [Windows::Foundation::Metadata::Default] ICurrentTemperatureConsumer
{
public:
    CurrentTemperatureConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~CurrentTemperatureConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<CurrentTemperatureJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ CurrentTemperatureWatcher^ watcher);

    // Call the SetLocation method
    Windows::Foundation::IAsyncOperation<CurrentTemperatureSetLocationResult^>^ SetLocationAsync(_In_ Platform::String^ interfaceMemberLocation);
    // This event fires whenever the value of Version changes.
    virtual event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Platform::Object^>^ VersionChanged;
    
    // Get the value of the Version property.
    Windows::Foundation::IAsyncOperation<CurrentTemperatureGetVersionResult^>^ GetVersionAsync();

    // This event fires whenever the value of CurrentValue changes.
    virtual event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Platform::Object^>^ CurrentValueChanged;
    
    // Get the value of the CurrentValue property.
    Windows::Foundation::IAsyncOperation<CurrentTemperatureGetCurrentValueResult^>^ GetCurrentValueAsync();

    // Get the value of the Location property.
    Windows::Foundation::IAsyncOperation<CurrentTemperatureGetLocationResult^>^ GetLocationAsync();


    // Used to send signals or register functions to handle received signals.
    property CurrentTemperatureSignals^ Signals
    {
        CurrentTemperatureSignals^ get() { return m_signals; }
    }

    // This event will fire whenever the consumer loses the session that it is a member of.
    virtual event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<CurrentTemperatureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    ...
    CurrentTemperatureSignals^ m_signals;
